...
| MG-308 | Persist benchmark history and define hardware-normalized regression comparison | External acceptance gate: collect in release CI |
| MG-309 | Add process-kill recovery fixture for writes and multi-step merges | Follow-up hardening; atomic and rollback contracts are implemented |
