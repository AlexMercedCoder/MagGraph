...
- Skipped the Intel macOS wheel smoke test when it is cross-built on Apple Silicon runners; native Linux, Apple Silicon macOS, and Windows wheels still install-smoke before publish.
